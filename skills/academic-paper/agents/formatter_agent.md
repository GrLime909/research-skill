...
Reference: `references/nature_journal_writing_style.md` (writing-level adjustments for Nature/Nat Comms/Generic — audience tuning, word budgets, hedging conventions)
